  ...
  useEffect(() => {
    const checkIfClickedOutside = (e: any) => {
      if (
        openNo ||
        openMenu ||
        (openLang && ref.current && !ref.current.contains(e.target))
      ) {
        setOpentLang(false);
        setOpenMenu(false);
        setOpenNo(false);
        ...
        <div className={useStyle.headerContainer}>
          ...
          <div className={useStyle.headerRight}>
            <ul className={useStyle.headerRightList}>
              ...
              <li onClick={openNoClick} className={useStyle.headerRightItem}>
                {userInfo ? (
                  <>
                    <img
              ...
              <li onClick={gotoCart} className={useStyle.headerRightItem}>
                <img src={icon.ShoppingCartSimple} alt="" />
                <span className={useStyle.headerCartCount}>
                  {carts.cartQuantity}
                </span>
              </li>
              <li className={useStyle.headerRightItem}>
            ...
            <Language openLang={openLang} openLangClick={openLangClick} />
          </div>
        </div>
      </Container>
    </div>
