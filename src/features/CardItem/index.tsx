...
function CardItem(props: any) {
  ...
  return (
    <div onClick={gotoDetail} style={{ width: style?.width }} className="card">
      <div
      ...
      <img
        src={"https://picsum.photos/650/976?random=" + detail.id}
        alt=""
        className="card-img"
      />
      <div className="card-info">
        ...
        <span className="card-spa-name">{org?.name}</span>
        <div className="flex-row-sp card-price">
          <span className="flex-row card-price__detail">
            ...
            <h3 style={special_price < 0 ? { display: "none" } : {}}>
